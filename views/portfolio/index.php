            ...
            <div class="project-card">
                ...
                <div class="project-info">
                    ...
                    <div class="project-actions">
                        ...
                        <button class="btn-small" onclick="openEditModal(<?= $project->id ?>, '<?= htmlspecialchars($project->title, ENT_QUOTES) ?>', '<?= htmlspecialchars($project->description ?? '', ENT_QUOTES) ?>')">
                        ...
                        <a href="<?= '/portfolio/view?slug=' . urlencode($project->slug) ?>" class="btn-small"
                            ...
                            <i class="fas fa-link"></i> <?= $t['copy_link_btn']; ?>
                        </a>
...
<div id="createModal" class="modal">
    <div class="modal-content">
        ...
        <form action="/portfolio/create" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group">
                <label for="background_image"><?= $t['background_image'] ?></label>
                <input type="file" id="background_image" name="background_image" accept="image/*">
                <small><?= $t['background_image_desc'] ?></small>
            </div>
            <div class="input-group">
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <form action="/portfolio/update" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group">
                <label for="edit_media_files">Adicionar Novas Mídias</label>
                <div style="display: flex; align-items: center; gap: 10px;">
                    <label for="edit_media_files" class="btn-small" style="margin: 0; cursor: pointer;">Escolher arquivos</label>
                    <span id="editFileLabel" style="color: var(--secondary-text-color); font-size: 0.9rem;">Nenhum arquivo escolhido</span>
                </div>
                <input type="file" id="edit_media_files" name="media_files[]" multiple accept="image/*,audio/*,video/mp4" style="display: none;" onchange="updateEditFileLabel(this)">
                <small>Deixe em branco para não adicionar novas mídias</small>
            </div>
...
<script>
    ...
    function openEditModal(id, title, description) {
        ...
        document.getElementById('editFileLabel').textContent = 'Nenhum arquivo escolhido';
        openModal('editModal');
    }
